...
class Music {
  ...
  updateSongInfo(playbackItem) {
    ...
    */
    ...
    var img_url
    if (playbackItem.cover) img_url = "/modules/MMM-GoogleAssistant/tmp/Music/" + playbackItem.cover +"?seed="+ playbackItem.seed
    else img_url = "/modules/MMM-GoogleAssistant/resources/music.jpg" +"?seed="+ playbackItem.seed
