...
function activate (that, payload) {
  ...
  that.assistant = new that.lib.Assistant.ASSISTANT(assistantConfig, (obj)=>{ that.sendSocketNotification("TUNNEL", obj) })
  ...
  var parser = new that.lib.Assistant.SCREENPARSER(parserConfig, that.config.debug)
  var result = null
