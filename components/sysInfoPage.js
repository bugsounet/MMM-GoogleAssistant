class sysInfoPage {
            ...
            Sysinfo_container_row.appendChild(Sysinfo_network)
              ...
              Sysinfo_network.appendChild(Sysinfo_network_group)
                ...
                Sysinfo_network_group.appendChild(Sysinfo_network_list)
                  ...
                  bitRate.id = "GATEWAY_ADMIN-SYSINFO_NETWORK-RATE"
                  ...
                  Sysinfo_network_list.appendChild(bitRate)
                    ...
                    bitRate_Value.id = "GATEWAY_ADMIN-SYSINFO_NETWORK-RATE-VALUE"
  ...
  refreshData() {
    ...
    var bitRate_ = document.getElementById("GATEWAY_ADMIN-SYSINFO_NETWORK-RATE")
    var bitRate = document.getElementById("GATEWAY_ADMIN-SYSINFO_NETWORK-RATE-VALUE")
